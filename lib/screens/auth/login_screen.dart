...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String? _validateEmailOrPhone(String? value) {
    ...
    final isPhone = phoneRegex.hasMatch(value.trim());
    if (!isEmail && !isPhone) {
  ...
  void _handleSignIn() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Form fields invalid triggers snackbar notification
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              color: icon == Icons.facebook ? const Color(0xff1877F2) : const Color(0xff1E40AF),
              size: icon == Icons.g_mobiledata_rounded ? 32 : 20,
            ),
            const SizedBox(width: 8),
            Text(
              text,
